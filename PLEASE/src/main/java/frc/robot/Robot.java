...
public class Robot extends TimedRobot {
  ...
  //private static Shoot shooter;
  public static PIDController leftDController;
  public static PIDController rightDController;
  
  public PIDDrive left;
  public PIDDrive right;

  public static PIDController shootControl;
  ...
  public void robotInit() {
    ...
    //shooter = RobotContainer.shootController;
  ...
  public void autonomousInit() {
    ...
    SequentialCommandGroup shoot = new SequentialCommandGroup(
      (Command) new Shoot(10, shootControl, shot)
    );
