...
public final class Constants {
    ...
    public static final double DRIVE_L_P = 0.01;
    public static final double DRIVE_L_I = 0.065;
    public static final double DRIVE_L_D = 0;
    public static final double DRIVE_R_P = 0.01;
    public static final double DRIVE_R_I = 1;
